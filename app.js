...
console.log(`The statement that the sum of all nums add up to 50 is : ${isSum50}`);
...
console.log(`The statement that two of the nums are odd is : ${isTwoOdd}`);
...
console.log(`The statement that any of our nums is over 25 is : ${isOver25}`);
...
console.log(`The statement that all the nums are unique is : ${isUnique}`);
...
console.log(`The statement that the four numbers are unique is : ${isValid}`);
